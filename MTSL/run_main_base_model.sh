...
CUDA_VISIBLE_DEVICES=0 python main_base_model.py --rnn_mode LSTM --num_epochs 200 --batch_size 16 \
 --hidden_size 1024 --num_layers 1 --char_dim 50 --num_filters 30 --learning_rate 0.01 --decay_rate 0.05 --schedule 1 \
 ...
 --out_path "output/base_model" --use_crf "True" --use_lm "True" --use_elmo "False" --label_type "chunk" \
 --bucket 5 10 15 20 25 30 40 50 60 70 80 \
 --train "data/chunk/train.chunk" \
 --dev "data/chunk/dev.chunk" \
 --test "data/chunk/test.chunk"
